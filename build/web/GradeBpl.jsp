...
cinterval = setInterval('countdown_timer', 1000);
    ...
    <body>
        <div id="head">
            <img src="TUCC-Logo_static.gif" width="10%"><p id="tname">Mnpl 2.0</p> <p id="tname">Mnpl 2.0</p> <p id="user">Welcome : <% out.println((String)s.getAttribute("email")); %> <span id="money">Money left : <% MnplBean mb=new MnplBean();out.println(mb.getMyMoney((String)s.getAttribute("email"))); %></span></p>
        </div>
        <div id="playerstats">
            <% int str=(Integer)s.getAttribute("id"); try{ResultSet rs =mb.srchIdB(str); if(rs==null){response.sendRedirect("GradeC.jsp");}%>
            <img src="images/gradeB/<% String str1=rs.getString(2); out.print(str1); s.setAttribute("info", str1);s.setAttribute("Grade", "B"); %>.jpg">
