...
<html>
    ...
    <body>
        ...
        <div id="playerstats">
            <% MnplBean mb=new MnplBean(); int str=(Integer)s.getAttribute("id"); try{ResultSet rs =mb.srchIdB(str); if(rs==null){response.sendRedirect("GradeC.jsp");}%>
            <img src="images/gradeB/<% String str1=rs.getString(2); out.print(str1);%>.jpg" width="30%" height="50%">
                       ...
                       <form name="frm" action="prev1" method="post"><input type="submit" value="Previous"></form><form name="frm" action="next1" method="post"><input type="submit" value="Next"></form>
