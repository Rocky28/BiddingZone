...
function countdown_timer(){
  ...
  if(max_time == 0){
    ...
    <body>
        ...
        <div id="playerstats">
            <%  int str=(Integer)s.getAttribute("id"); try{ResultSet rs =mb.srchIdA(str); if(rs==null){response.sendRedirect("GradeB.jsp");}%>
            <img src="images/gradeA/<% String str1=rs.getString(1); out.print(str1);s.setAttribute("info", str1);s.setAttribute("Grade", "A"); %>.jpg">
