...
function countdown_timer(){
  ...
  if(max_time == 0){
    ...
    <body>
        ...
        <div id="playerstats">
            <% int str=(Integer)s.getAttribute("id"); try{ResultSet rs =mb.srchIdCUnsold(str); if(rs==null){int id=1;s.setAttribute("id",id);response.sendRedirect("Unsold_GradeDpl.jsp");}%>
            <img src="images/gradeC/<% str=rs.getInt("ID");s.setAttribute("id",str);String str1=rs.getString(2); out.print(str1);s.setAttribute("info", str1);s.setAttribute("Grade", "C");%>.jpg">
