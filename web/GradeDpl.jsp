...
cinterval = setInterval('countdown_timer', 1000);
    ...
    <body>
        ...
        <div id="playerstats">
            <%  int str=(Integer)s.getAttribute("id"); try{ResultSet rs =mb.srchIdD(str); if(rs==null){response.sendRedirect("final.jsp");}%>
            <img src="images/gradeD/<% String str1=rs.getString(2); out.print(str1);out.print(str1);s.setAttribute("info", str1);s.setAttribute("Grade", "D"); %>.jpg">
