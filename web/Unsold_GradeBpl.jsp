...
function countdown_timer(){
  ...
  if(max_time == 0){
    ...
    <body>
        ...
        <div id="playerstats">
            <% int str=(Integer)s.getAttribute("id"); try{ResultSet rs =mb.srchIdBUnsold(str); if(rs==null){int id=1;s.setAttribute("id",id);response.sendRedirect("Unsold_GradeCpl.jsp");}%>
            <img src="images/gradeB/<% str=rs.getInt("ID");s.setAttribute("id",str);String str1=rs.getString(2); out.print(str1); s.setAttribute("info", str1);s.setAttribute("Grade", "B"); %>.jpg">
            ...
            <table>
                ...
                <tr><th><form action="bid" method="post"><input type="submit" value="Bid"></form></th><td id="timer">5td></tr>
            </table>
        </div>
        <div id="owned">
